...
<body <?php body_class( $body_classes ); ?> data-spy="scroll">
	<?php 
		...
		require(dirname( __FILE__ ) . "/inc/check-session.php");
	?>
	<div class="topbar">
	<?php 
        $url = '/login';
	...
	<div class="widget">
		<ul class="memberlink">
			<li>
				<a href="https://www.plt.org/custom-login" id="link">Login</a></li>
		</ul>
	</div>

	<div id="bootstrapbasic_search_widget-2" class="widget widget_bootstrapbasic_search_widget">
		<form class="navbar-form navbar-right" action="https://www.plt.org/" role="search" _lpchecked="1">
			<div class="form-group"><input type="text" name="s" class="form-control" placeholder="Search …" value="" title="Search for:"></div> 

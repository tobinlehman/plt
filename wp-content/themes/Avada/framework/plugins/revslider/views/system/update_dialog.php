...
ckage. The files will be overwriten. 
		...
		<form action="<?php echo UniteBaseClassRev::$url_ajax?>" enctype="multipart/form-data" method="post">
		    ...
		    <br>
			<input type="file<div id="dialog_update_plugin" class="api_wrapper" title="Update Slider Plugin" style="display:none;">
		<div class="api-caption">Update Revolution Slider Plugin:</div>
		<div class="api-desc">
			To update the slider please show the slider install pa" name="update_file" class="input_update_slider">

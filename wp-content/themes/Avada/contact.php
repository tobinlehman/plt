		...
		<?php while(have_posts()): the_post(); ?>
			...
			<div class="post-content">
				...
				<?php if(isset($emailSent) && $emailSent == true) { //If email is sent ?>
					<div class="alert success"><div class="msg"><?php echo __('Thank you', 'Avada'); ?> <strong><?php echo $name;?></strong> <?php echo __('for using our contact form! Your email was successfully sent!', 'Avada'); ?></div></div>
					<br />
				<?php } ?>
			</div>
...
<select class="input-website" name="url" id="url">

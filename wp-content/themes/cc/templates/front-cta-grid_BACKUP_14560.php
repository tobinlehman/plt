...
=======
								<?php wp_nav_menu( array('theme_location'  => 'order-guides')); ?>
>>>>>>> Stashed changes
								<span class="icon">
			...
			<div class="row no-p-m">
				<div class="col-sm-6 col-md-6 no-p-m">
					<div class="col-sm-6 col-md-6 community-conversations">
						<a class="hover-community" href="http://cc.devsite.work/forums/forum/coordinators-corner/"><img src="<?php echo IMG; ?>/icon-conversation@2x.png">
						<h2>

								...
								<ul>
									<li>
										<a target="_blank" href="<?php echo $shop_index_url; ?>">
											<i class="fa fa-external-link" aria-hidden="true"></i> PLT Store
										</a>
									</li>
									<li>
										<a target="_blank" href="http://shop.plt.org/~userInfo">
											<i class="fa fa-external-link" aria-hidden="true"></i> Transaction History
										</a>
									</li>
									<li>
										<a target="_blank" href="http://shop.plt.org/cart">
											<i class="fa fa-external-link" aria-hidden="true"></i> Other Orders
										</a>
									</li>
								</ul>
								<span class="icon">
				...
				<div class="col-sm-6 col-md-6 no-p-m cta-col-pl-5">
					<div class="row no-p-m">
								...
								<ul>
									<li>
										<a href="<?php echo $state_user_detail_url; ?>">
											<i class="fa fa-external-link" aria-hidden="true"></i>  Quarterly SRF
										</a>
									</li>
									<li>
						...
						<div class="col-md-12 no-p-m cta-dark cf">
							...
							<div class="link-container">
								<ul class="front-cta-mpi-grants">
									<li>
										<a href="<?php echo SITE; ?>/wp-content/uploads/2017/02/2017-MPI-Grant-RFP.doc">
											2017 MPI RFP
										</a>
									</li>
									<li>
										<a href="<?php echo SITE; ?>/wp-content/uploads/2017/02/2017-MPI-Grant-Proposal-Form.doc">
											2017 MPI Grant Proposal Form
										</a>
									</li>
									<li>
										<a href="<?php echo SITE; ?>/funding/mpi-grants/past-grant-summaries/">
											Past Grant Summaries
											<br>
											<br>
										</a>
									</li>
						...
						<div class="col-md-12 no-p-m cta-light cf">
							...
							<div class="link-container">
								<ul>
									<li>
										<a href="https://plt.forms-db.com/view.php?id=11142">
											<i class="fa fa-external-link" aria-hidden="true"></i>  Register
										</a>
									</li>
									<li>
										<a href="https://docs.google.com/document/d/1KpqcuFR7nEgAZfAb9jHoMaEnPtfJf_PjGYQCJAHEDiQ/edit">
											<i class="fa fa-external-link" aria-hidden="true"></i> Registration Memo
										</a>
									</li>
									<li>
										<a href="<?php echo SITE; ?>/marketing-communications/coordinators-conference/conference-program/">
											Conference Program
										</a>
									</li>
									<li>
										<a href="https://drive.google.com/open?id=0B5nR1uBuXMgAUU44RUVNaTBzUXc">
											<i class="fa fa-external-link" aria-hidden="true"></i> Conference Proceedings
										</a>
									</li>
								</ul>
								<span class="icon">
			...
			<div class="row no-p-m">
				<div class="col-sm-6 col-md-6 no-p-m">
					<div class="col-sm-6 col-md-6 community-conversations">
						<img src="<?php echo IMG; ?>/icon-conversation@2x.png">
						<h2>
					...
					<?php } wp_reset_query(); ?>
					<!-- <div class="col-md-12 conversation">
						<a>This is a sample of a title of a conversation that is happening >></a>
						<div class="meta-info">
							<span class="date">1/7/17</span> - <span class="author">By Name of User</span> | <span class="replies"># Replies</span>
						</div>
					</div>
					<div class="col-md-12 conversation">
						<a>This is a sample of a title of a conversation that is happening >></a>

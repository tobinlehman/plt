...
<?php get_sidebar('left'); ?> 
				...
				<div class="keylinks">
					<div class="widget">
									 <h2><a href="/environmental-education-curriculum/">Curriculum Overview</a></h2>
									 <p>Our lesson plans for all grade levels are fun, flexible, and easy to use. Each includes background for teachers and student assessment tools.</p>
									 <p><a href="/environmental-education-curriculum/"><img src="/wp-content/themes/bootstrap-basic-child/img/white_arrow.png" alt="Icon: white arrow" /></a></p>
								 </div>
					<?php
							$orig_post = $post;

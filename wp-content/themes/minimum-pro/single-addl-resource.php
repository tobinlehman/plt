 ...
 *
 *
 * PLT Additional Resource Page Post Type Template *
 * 
 */
...
function rp_activity_menu_widget(){
  genesis_widget_area( 'activity-menu-widget', array(
		'before' => '<nav class="nav-primary rp-topic-conditional-menu" itemtype="http://schema.org/SiteNavigationElement" itemscope="itemscope" role="navigation"><div class="wrap">',
		'after'  => '</div></nav>',
	) );
}

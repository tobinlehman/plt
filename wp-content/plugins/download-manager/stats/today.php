...
<script src="<?php echo plugins_url(); ?>/download-manager/js/raphael.js"></script>
<script src="<?php echo plugins_url(); ?>/download-manager/js/popup.js"></script>
<script src="<?php echo plugins_url(); ?>/download-manager/js/analytics.js"></script>
<?php
global $wpdb;

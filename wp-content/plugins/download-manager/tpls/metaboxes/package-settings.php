...
<div id="package-settings" class="tabc">
    <table cellpadding="5" id="file_settings_table" cellspacing="0" width="100%" class="frm">
        <tr id="version_row">
            ...
            <td><input size="10" type="text" style="width: 100px" value="<?php echo get_post_meta($post->ID,'__wpdm_version',true); ?>" name="file[version]" />
            </td></tr>
        ...
        <tr id="downliad_limit_row">
            ...
            <td><input size="10" style="width: 80px" type="number" name="file[download_limit_per_user]" value="<?php echo get_post_meta($post->ID,'__wpdm_download_limit_per_user', true); ?>" /> / user <span class="info infoicon" title="For non-registered members IP will be taken as ID">&nbsp;</span></td>
        </tr>

        <tr id="view_count_row">
            <td><?php echo __('View&nbsp;Count:','wpdmpro'); ?></td>
            <td><input size="10" style="width: 80px" type="number" name="file[view_count]" value="<?php echo get_post_meta($post->ID,'__wpdm_view_count',true); ?>" /> <span class="info infoicon" title="Set/Reset Download Count for this package">&nbsp;</span></td>
        </tr>

       <tr id="download_count_row">
            <td><?php echo __('Download&nbsp;Count:','wpdmpro'); ?></td>
            <td><input size="10" style="width: 80px" type="number" name="file[download_count]" value="<?php echo get_post_meta($post->ID,'__wpdm_download_count',true); ?>" /> <span class="info infoicon" title="Set/Reset Download Count for this package">&nbsp;</span></td>
        </tr>

       <tr id="package_size_row">
            <td><?php echo __('Package&nbsp;Size:','wpdmpro'); ?></td>
            <td><input size="10" style="width: 80px" type="text" name="file[package_size]" value="<?php echo get_post_meta($post->ID,'__wpdm_package_size',true); ?>" /> <span class="info infoicon" title="Total size of included files with this package.">&nbsp;</span></td>
        </tr>
                ...
                <select name="file[template]" id="lnk_tpl" onchange="jQuery('#lerr').remove();">
                    ...
                    if(is_array($templates)){
                        foreach($templates as $id=>$template) {
                            ?>
                            <option value="<?php echo $id; ?>"  <?php selected(get_post_meta($post->ID,'__wpdm_template',true),$id); ?>><?php echo $template['title']; ?></option>
                        <?php } } ?>
                </select>
            </td>
        </tr>

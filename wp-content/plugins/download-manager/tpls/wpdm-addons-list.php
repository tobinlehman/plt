gins_url('/download-manager/js/chosen.jquery.min.js'); ?>"></script>
...
<script language="JavaScript" src="<?php echo plu       border-bottom:0px;
    }
    #screen-meta-links{
        display: none;
    }
...
echo ' <div class="col-md-12"><div class="panel panel-default"><div class="panel-heading"><h3>'. __('WPDM Add-Ons','wpdmpro').'</h3></div><div class="panel-body"><ul class="nav nav-pills" id="filter-mods"><li class="active"><a href="#all" rel="all">All Add-Ons</a></li>';
foreach($cats as $cat){
...
<div class="media">
    ...
    <div class="panel-footer" style="line-height: 30px;">
        <div class="pull-right" style="margin-top: -2px">
            ...
            <?php } else { ?>
                <a class="btn btn-sm btn-primary btn-install" data-toggle="modal" rel="<?php echo $package->ID; ?>" data-backdrop="true" data-target="#addonmodal" href="#" style="border: 0;border-radius: 2px"><i class="fa fa-download"></i> &nbsp;Download & Install</a>
            <?php } ?>
        </div>

...
<div class="row">
                                                <div class="col-md-6"><label for="name">Display name: </label><input type="text" class="required form-control" value="<?php echo $user->display_name;?>" name="profile[display_name]" id="name"></div>
                                                ...
                                                <div class="col-md-12 clear"><label for="message">Description:</label><textarea class="text form-control" cols="40" rows="8" name="profile[description]" id="message"><?php echo htmlspecialchars(stripslashes($current_user->description));?></textarea></div>

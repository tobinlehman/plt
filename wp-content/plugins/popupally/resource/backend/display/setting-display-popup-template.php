	...
	<div hide-toggle="is-open" data-dependency="display-toggle-{{id}}" data-dependency-value="true">
		...
		<div class="popupally-setting-section popupally-conditional-display-{{id}}" {{display-page-selection}}>
			...
			<div class="popupally-setting-configure-block">
				...
				<a class="popupally-trial-button" href="http://www.ambitionally.com/popupally-free-link/" target="_blank"><span class="popupally-click-arrow"></span>Try PopupAlly Pro for $1!</a>
			</div>
		</div>
				...
				<table class="popupally-setting-configure-table">
					<tbody>
						<tr>
							...
							<td>
								<div>
									<label for="show-thank-you-setup-{{id}}">Advanced functionality. Make sure to follow the <a class="underline" target="_blank" href="http://ambitionally.com/popupally/tutorials/thank-you-page-setup/">Thank You Page Setup Tutorial</a> before enabling</label>
								</div>
							</td>
						</tr>
					</tbody>

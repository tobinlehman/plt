...
<table class="popupally-setting-container">
	<tbody>
		...
		<tr>
			...
			<td rowspan="6" class="popupally-setting-content-cell popupally-setting-right-col">
				...
				<div class="popupally-setting-content-container" style="display:<?php echo $setting['selected-tab']==='stats'?'block':'none'; ?>;" popup-tab-group-1="stats">
					<div class="popupally-setting-section">
						...
						<a class="popupally-trial-button" href="http://www.ambitionally.com/popupally-free-link/" target="_blank"><span class="popupally-click-arrow"></span>Get PopupAlly Pro now!</a>
						<div class="popupally-setting-configure-block">
							<a href="http://www.ambitionally.com/popupally-free-link/" target="_blank">

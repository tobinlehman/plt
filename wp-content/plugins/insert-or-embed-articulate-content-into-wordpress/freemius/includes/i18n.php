<?php
	...
	$fs_text = array(
		...
		'connect-message'                          => _fs_text( 'By opting in you will receive an email with instructions on how to use the plugin and a promo code to purchase the premium version of this plugin. If you skip this, that\'s okay! The plugin will still work just fine.' ),
		'connect-message_on-update'                => _fs_text( 'By opting in you will receive an email with instructions on how to use the plugin and a promo code to purchase the premium version of this plugin. If you skip this, that\'s okay! The plugin will still work just fine.' ),

...
function add_new_button()
{
	...
	jQuery("#button_area").append('<div class="button_box" title="Delete"><div class="close_button"></div><div class="imgbox"></div><input type="text" size="20" name="buttons[]" class="image_source validate" value="">&nbsp;<a class="img_upload_button btn-floating btn-large waves-effect waves-light blue addimgero"><i class="material-icons">perm_media</i></a></div>');	

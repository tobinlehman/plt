 ...
 * @version    $Id: WinCache.php 1411129 2016-05-05 16:15:58Z worschtebrot $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Cache_Backend_WinCache extends IfwPsn_Vendor_Zend_Cache_Backend implements IfwPsn_Vendor_Zend_Cache_Backend_ExtendedInterface
{
    /**
     * Log message
     */
    const TAGS_UNSUPPORTED_BY_CLEAN_OF_WINCACHE_BACKEND = 'IfwPsn_Vendor_Zend_Cache_Backend_WinCache::clean() : tags are unsupported by the WinCache backend';
    const TAGS_UNSUPPORTED_BY_SAVE_OF_WINCACHE_BACKEND =  'IfwPsn_Vendor_Zend_Cache_Backend_WinCache::save() : tags are unsupported by the WinCache backend';

...
class afo_forgot_pass_class {
	...
	public function ForgotPassForm(){
		...
		<form name="forgot" id="forgot" method="post" action="" autocomplete="off" <?php echo do_action( 'lwws_forgot_password_form_tag' );?>>
		<input type="hidden" name="option" value="afo_forgot_pass" />
			...
			<input type="email" name="userusername" required <?php echo do_action( 'lwws_fp_userusername_field' );?>/>
			</div>
			
			<div class="forgot-pass-form-group"><input name="forgot" type="submit" value="<?php _e('Submit','login-sidebar-widget');?>" <?php echo do_action( 'lwws_forgot_password_form_submit_tag' );?>/></div>

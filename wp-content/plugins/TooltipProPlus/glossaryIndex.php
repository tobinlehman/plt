...
class CMTT_Glossary_Index {
	...
	protected static $shortcodeDisplayed = false;
	...
	public static function outputSearch( $shortcodeAtts ) {
		...
		<input type="search" value="<?php echo esc_attr( $searchTerm ) ?>" class="glossary-search-term <?php echo esc_attr( $additionalClass ) ?>" name="search_term" id="glossary-search-term" />

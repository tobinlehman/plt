                ...
                } else
                {
                    ...
                    } else
                    {
                        ...
                        $( this ).mouseenter( function ( e ) {
                            clearTimeout( CM_Tooltip.timeoutId );
                            console.log("test");
                            $(this).hasClass('cmtt_C3') && $('body').hasClass('c3-toggle')
                            if($('body').hasClass('all-toggle') 
                                ||  $(this).hasClass('cmtt_C3') && $('body').hasClass('c3-toggle')
                                ||  $(this).hasClass('cmtt_NGSS') && $('body').hasClass('ngss-toggle')
                                ||  $(this).hasClass('cmtt_CCSS') && $('body').hasClass('ccss-toggle')
                            ){

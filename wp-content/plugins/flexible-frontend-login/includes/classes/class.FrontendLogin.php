	...
	public $html_block = '
										<table class="ffl-form-table">
										   <tbody>
											 ...
											 <tr class="ffl-form-table-row">
												 <td class="ffl-table-cell-left">%lost_password%</td>
<td class="ffl-table-cell-right"><a href="http://sfrc.ufl.edu/extension/ee/climate/wp-login.php?action=register">Need to Register?</a></td>
											  </tr>
										   </tbody>
										</table>';

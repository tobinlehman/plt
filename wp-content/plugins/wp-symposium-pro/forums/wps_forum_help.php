		...
		<?php
  		...
  		echo '<div style="border:1px dashed #333; background-color:#efefef; margin-bottom:10px; padding-left:15px">';
			...
			echo '<p>';
		  	...
		  	echo '<strong>['.WPS_PREFIX.'-forum-reply slug="general-forum"]</strong> <span class="description">'.__("Show the 'Add Comment' form for the 'general-forum' forum", WPS2_TEXT_DOMAIN).'</span><br />';

...
<div class="fa-horizontal-tabs" id="fa-themes-tabs">
	...
	<div class="fa-themes" id="fa-registered-themes">
		...
		<div class="alert">
			...
			<?php printf( __( 'If you create additional themes or additional color schemes to existing themes, please make sure that you first %smove slider themes outside plugin folder%s.', 'fapro' ), '<a href="http://www.codeflavors.com/documentation/intermediate-tutorials/moving-slider-themes-folder/" target="_blank">' ,'</a>');?>		
		</div>
		<?php endif;?>
	...
	<!-- Theme layout -->
	<div id="fa-theme-layout-settings" class="hide-if-js">
	...
	<!-- Theme settings tab -->
	<div class="fa-theme-settings hide-if-js" id="fa-theme-slider-settings">		
	...
	<div id="fa-theme-slider-publish" class="hide-if-js">
		<table class="form-table">
			<tbody>
				<tr>

...
<tr valign="top">
  ...
  <td>
    <input type="text" name="created_at" id="created_at" value="<?php echo MeprAppHelper::format_date($txn->created_at, gmdate('Y-m-d'), 'Y-m-d'); ?>" class="regular-text mepr-date-picker"/>&nbsp;<a href="#" class="mepr-today-button button" data-id="created_at"><?php _e('Today', 'memberpress'); ?></a>

 ...
 * @version    $Id: Disk.php 1411129 2016-05-05 16:15:58Z worschtebrot $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Cache_Backend_ZendServer_Disk extends IfwPsn_Vendor_Zend_Cache_Backend_ZendServer implements IfwPsn_Vendor_Zend_Cache_Backend_Interface
{
    /**
     * Constructor
     *
    ...
    public function __construct(array $options = array())
    {
        if (!function_exists('zend_disk_cache_store')) {
            IfwPsn_Vendor_Zend_Cache::throwException('IfwPsn_Vendor_Zend_Cache_ZendServer_Disk backend has to be used within Zend Server environment.');
        }

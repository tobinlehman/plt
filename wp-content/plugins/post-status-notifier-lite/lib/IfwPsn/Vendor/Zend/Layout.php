 ...
 * @version    $Id: Layout.php 1411129 2016-05-05 16:15:58Z worschtebrot $
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Layout
{
    /**
     * Placeholder container for layout variables
     * @var IfwPsn_Vendor_Zend_View_Helper_Placeholder_Container
     */
     ...
     * @var string
     */
    protected $_helperClass = 'IfwPsn_Vendor_Zend_Layout_Controller_Action_Helper_Layout';
     ...
     * @var string
     */
    protected $_pluginClass = 'IfwPsn_Vendor_Zend_Layout_Controller_Plugin_Layout';
     ...
     * - An array of options
     * - A IfwPsn_Vendor_Zend_Config object with options
     *
    ...
    public function __construct($options = null, $initMvc = false)
    {
        if (null !== $options) {
            if (is_string($options)) {
                ...
                throw new IfwPsn_Vendor_Zend_Layout_Exception('Invalid option provided to constructor');
            }
        }
    ...
    public static function startMvc($options = null)
    {
        if (null === self::$_mvcInstance) {
            ...
            } elseif (is_array($options) || $options instanceof IfwPsn_Vendor_Zend_Config) {
    ...
    /**
     * Retrieve MVC instance of IfwPsn_Vendor_Zend_Layout object
     *
     * @return IfwPsn_Vendor_Zend_Layout|null
     */
    ...
    public function setOptions($options)
    {
        if ($options instanceof IfwPsn_Vendor_Zend_Config) {
            ...
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Layout/Exception.php';
            throw new IfwPsn_Vendor_Zend_Layout_Exception('setOptions() expects either an array or a IfwPsn_Vendor_Zend_Config object');
        }
     ...
     * @return IfwPsn_Vendor_Zend_Layout
     */
    public function setInflector(IfwPsn_Vendor_Zend_Filter_Inflector $inflector)
    {
    ...
    public function getInflector()
    {
        if (null === $this->_inflector) {
            ...
            $inflector = new IfwPsn_Vendor_Zend_Filter_Inflector();
     ...
     * @return IfwPsn_Vendor_Zend_Layout
     * @throws IfwPsn_Vendor_Zend_Layout_Exception if non-array/string value passed to $spec
     */
    public function assign($spec, $value = null)
    {
        ...
        require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Layout/Exception.php';
        throw new IfwPsn_Vendor_Zend_Layout_Exception('Invalid values passed to assign()');
    }

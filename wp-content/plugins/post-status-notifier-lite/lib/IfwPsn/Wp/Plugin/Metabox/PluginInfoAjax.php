 ...
 * @version  $Id: PluginInfoAjax.php 1411129 2016-05-05 16:15:58Z worschtebrot $
 */ 
class IfwPsn_Wp_Plugin_Metabox_PluginInfoAjax extends IfwPsn_Wp_Ajax_Request
{
    ...
    protected function _addHelpBlock()
    {
        ...
        if (!empty($this->_pm->getConfig()->plugin->docUrl)) {
            $content .= sprintf('<a href="%s" target="_blank">%s</a>', $this->_pm->getConfig()->plugin->docUrl, __('Documentation', 'asa2')) . '<br>';
        }
